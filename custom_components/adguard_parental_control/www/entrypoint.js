 ...
 */const me=globalThis,Ce=me.ShadowRoot&&(me.ShadyCSS===void 0||me.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,ke=Symbol(),Se=new WeakMap;let We=class{constructor(e,i,s){if(this._$cssResult$=!0,s!==ke)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=i}get styleSheet(){let e=this.o;const i=this.t;if(Ce&&e===void 0){const s=i!==void 0&&i.length===1;s&&(e=Se.get(i)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),s&&Se.set(i,e))}return e}toString(){return this.cssText}};const Xe=t=>new We(typeof t=="string"?t:t+"",void 0,ke),C=(t,...e)=>{const i=t.length===1?t[0]:e.reduce((s,a,r)=>s+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(a)+t[r+1],t[0]);return new We(i,t,ke)},Je=(t,e)=>{if(Ce)t.adoptedStyleSheets=e.map(i=>i instanceof CSSStyleSheet?i:i.styleSheet);else for(const i of e){const s=document.createElement("style"),a=me.litNonce;a!==void 0&&s.setAttribute("nonce",a),s.textContent=i.cssText,t.appendChild(s)}},Me=Ce?t=>t:t=>t instanceof CSSStyleSheet?(e=>{let i="";for(const s of e.cssRules)i+=s.cssText;return Xe(i)})(t):t;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:et,defineProperty:tt,getOwnPropertyDescriptor:it,getOwnPropertyNames:st,getOwnPropertySymbols:at,getPrototypeOf:ot}=Object,W=globalThis,Pe=W.trustedTypes,rt=Pe?Pe.emptyScript:"",_e=W.reactiveElementPolyfillSupport,re=(t,e)=>t,be={toAttribute(t,e){switch(e){case Boolean:t=t?rt:null;break;case Object:case Array:t=t==null?t:JSON.stringify(t)}return t},fromAttribute(t,e){let i=t;switch(e){case Boolean:i=t!==null;break;case Number:i=t===null?null:Number(t);break;case Object:case Array:try{i=JSON.parse(t)}catch{i=null}}return i}},Ae=(t,e)=>!et(t,e),Te={attribute:!0,type:String,converter:be,reflect:!1,useDefault:!1,hasChanged:Ae};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),W.litPropertyMetadata??(W.litPropertyMetadata=new WeakMap);let J=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??(this.l=[])).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,i=Te){if(i.state&&(i.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((i=Object.create(i)).wrapped=!0),this.elementProperties.set(e,i),!i.noAccessor){const s=Symbol(),a=this.getPropertyDescriptor(e,s,i);a!==void 0&&tt(this.prototype,e,a)}}static getPropertyDescriptor(e,i,s){const{get:a,set:r}=it(this.prototype,e)??{get(){return this[i]},set(o){this[i]=o}};return{get:a,set(o){const c=a==null?void 0:a.call(this);r==null||r.call(this,o),this.requestUpdate(e,c,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??Te}static _$Ei(){if(this.hasOwnProperty(re("elementProperties")))return;const e=ot(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(re("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(re("properties"))){const i=this.properties,s=[...st(i),...at(i)];for(const a of s)this.createProperty(a,i[a])}const e=this[Symbol.metadata];if(e!==null){const i=litPropertyMetadata.get(e);if(i!==void 0)for(const[s,a]of i)this.elementProperties.set(s,a)}this._$Eh=new Map;for(const[i,s]of this.elementProperties){const a=this._$Eu(i,s);a!==void 0&&this._$Eh.set(a,i)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){const i=[];if(Array.isArray(e)){const s=new Set(e.flat(1/0).reverse());for(const a of s)i.unshift(Me(a))}else e!==void 0&&i.push(Me(e));return i}static _$Eu(e,i){const s=i.attribute;return s===!1?void 0:typeof s=="string"?s:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){var e;this._$ES=new Promise(i=>this.enableUpdating=i),this._$AL=new Map,this._$E_(),this.requestUpdate(),(e=this.constructor.l)==null||e.forEach(i=>i(this))}addController(e){var i;(this._$EO??(this._$EO=new Set)).add(e),this.renderRoot!==void 0&&this.isConnected&&((i=e.hostConnected)==null||i.call(e))}removeController(e){var i;(i=this._$EO)==null||i.delete(e)}_$E_(){const e=new Map,i=this.constructor.elementProperties;for(const s of i.keys())this.hasOwnProperty(s)&&(e.set(s,this[s]),delete this[s]);e.size>0&&(this._$Ep=e)}createRenderRoot(){const e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Je(e,this.constructor.elementStyles),e}connectedCallback(){var e;this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$EO)==null||e.forEach(i=>{var s;return(s=i.hostConnected)==null?void 0:s.call(i)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$EO)==null||e.forEach(i=>{var s;return(s=i.hostDisconnected)==null?void 0:s.call(i)})}attributeChangedCallback(e,i,s){this._$AK(e,s)}_$ET(e,i){var r;const s=this.constructor.elementProperties.get(e),a=this.constructor._$Eu(e,s);if(a!==void 0&&s.reflect===!0){const o=(((r=s.converter)==null?void 0:r.toAttribute)!==void 0?s.converter:be).toAttribute(i,s.type);this._$Em=e,o==null?this.removeAttribute(a):this.setAttribute(a,o),this._$Em=null}}_$AK(e,i){var r,o;const s=this.constructor,a=s._$Eh.get(e);if(a!==void 0&&this._$Em!==a){const c=s.getPropertyOptions(a),l=typeof c.converter=="function"?{fromAttribute:c.converter}:((r=c.converter)==null?void 0:r.fromAttribute)!==void 0?c.converter:be;this._$Em=a;const h=l.fromAttribute(i,c.type);this[a]=h??((o=this._$Ej)==null?void 0:o.get(a))??h,this._$Em=null}}requestUpdate(e,i,s,a=!1,r){var o;if(e!==void 0){const c=this.constructor;if(a===!1&&(r=this[e]),s??(s=c.getPropertyOptions(e)),!((s.hasChanged??Ae)(r,i)||s.useDefault&&s.reflect&&r===((o=this._$Ej)==null?void 0:o.get(e))&&!this.hasAttribute(c._$Eu(e,s))))return;this.C(e,i,s)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,i,{useDefault:s,reflect:a,wrapped:r},o){s&&!(this._$Ej??(this._$Ej=new Map)).has(e)&&(this._$Ej.set(e,o??i??this[e]),r!==!0||o!==void 0)||(this._$AL.has(e)||(this.hasUpdated||s||(i=void 0),this._$AL.set(e,i)),a===!0&&this._$Em!==e&&(this._$Eq??(this._$Eq=new Set)).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(i){Promise.reject(i)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var s;if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(const[r,o]of this._$Ep)this[r]=o;this._$Ep=void 0}const a=this.constructor.elementProperties;if(a.size>0)for(const[r,o]of a){const{wrapped:c}=o,l=this[r];c!==!0||this._$AL.has(r)||l===void 0||this.C(r,void 0,o,l)}}let e=!1;const i=this._$AL;try{e=this.shouldUpdate(i),e?(this.willUpdate(i),(s=this._$EO)==null||s.forEach(a=>{var r;return(r=a.hostUpdate)==null?void 0:r.call(a)}),this.update(i)):this._$EM()}catch(a){throw e=!1,this._$EM(),a}e&&this._$AE(i)}willUpdate(e){}_$AE(e){var i;(i=this._$EO)==null||i.forEach(s=>{var a;return(a=s.hostUpdated)==null?void 0:a.call(s)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&(this._$Eq=this._$Eq.forEach(i=>this._$ET(i,this[i]))),this._$EM()}updated(e){}firstUpdated(e){}};J.elementStyles=[],J.shadowRootOptions={mode:"open"},J[re("elementProperties")]=new Map,J[re("finalized")]=new Map,_e==null||_e({ReactiveElement:J}),(W.reactiveElementVersions??(W.reactiveElementVersions=[])).push("2.1.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ne=globalThis,De=t=>t,ve=ne.trustedTypes,Ee=ve?ve.createPolicy("lit-html",{createHTML:t=>t}):void 0,Be="$lit$",F=`lit$${Math.random().toFixed(9).slice(2)}$`,Ue="?"+F,nt=`<${Ue}>`,Q=document,le=()=>Q.createComment(""),ce=t=>t===null||typeof t!="object"&&typeof t!="function",Le=Array.isArray,lt=t=>Le(t)||typeof(t==null?void 0:t[Symbol.iterator])=="function",xe=`[ 	
\f\r]`,oe=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,ze=/-->/g,Ne=/>/g,U=RegExp(`>|${xe}(?:([^\\s"'>=/]+)(${xe}*=${xe}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),qe=/'/g,Ve=/"/g,Ze=/^(?:script|style|textarea|title)$/i,Ge=t=>(e,...i)=>({_$litType$:t,strings:e,values:i}),n=Ge(1),N=Ge(2),ee=Symbol.for("lit-noChange"),m=Symbol.for("lit-nothing"),Oe=new WeakMap,Z=Q.createTreeWalker(Q,129);function Qe(t,e){if(!Le(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return Ee!==void 0?Ee.createHTML(e):e}const ct=(t,e)=>{const i=t.length-1,s=[];let a,r=e===2?"<svg>":e===3?"<math>":"",o=oe;for(let c=0;c<i;c++){const l=t[c];let h,u,b=-1,O=0;for(;O<l.length&&(o.lastIndex=O,u=o.exec(l),u!==null);)O=o.lastIndex,o===oe?u[1]==="!--"?o=ze:u[1]!==void 0?o=Ne:u[2]!==void 0?(Ze.test(u[2])&&(a=RegExp("</"+u[2],"g")),o=U):u[3]!==void 0&&(o=U):o===U?u[0]===">"?(o=a??oe,b=-1):u[1]===void 0?b=-2:(b=o.lastIndex-u[2].length,h=u[1],o=u[3]===void 0?U:u[3]==='"'?Ve:qe):o===Ve||o===qe?o=U:o===ze||o===Ne?o=oe:(o=U,a=void 0);const I=o===U&&t[c+1].startsWith("/>")?" ":"";r+=o===oe?l+nt:b>=0?(s.push(h),l.slice(0,b)+Be+l.slice(b)+F+I):l+F+(b===-2?c:I)}return[Qe(t,r+(t[i]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),s]};class de{constructor({strings:e,_$litType$:i},s){let a;this.parts=[];let r=0,o=0;const c=e.length-1,l=this.parts,[h,u]=ct(e,i);if(this.el=de.createElement(h,s),Z.currentNode=this.el.content,i===2||i===3){const b=this.el.content.firstChild;b.replaceWith(...b.childNodes)}for(;(a=Z.nextNode())!==null&&l.length<c;){if(a.nodeType===1){if(a.hasAttributes())for(const b of a.getAttributeNames())if(b.endsWith(Be)){const O=u[o++],I=a.getAttribute(b).split(F),ue=/([.?@])?(.*)/.exec(O);l.push({type:1,index:r,name:ue[2],strings:I,ctor:ue[1]==="."?pt:ue[1]==="?"?ht:ue[1]==="@"?gt:fe}),a.removeAttribute(b)}else b.startsWith(F)&&(l.push({type:6,index:r}),a.removeAttribute(b));if(Ze.test(a.tagName)){const b=a.textContent.split(F),O=b.length-1;if(O>0){a.textContent=ve?ve.emptyScript:"";for(let I=0;I<O;I++)a.append(b[I],le()),Z.nextNode(),l.push({type:2,index:++r});a.append(b[O],le())}}}else if(a.nodeType===8)if(a.data===Ue)l.push({type:2,index:r});else{let b=-1;for(;(b=a.data.indexOf(F,b+1))!==-1;)l.push({type:7,index:r}),b+=F.length-1}r++}}static createElement(e,i){const s=Q.createElement("template");return s.innerHTML=e,s}}function te(t,e,i=t,s){var o,c;if(e===ee)return e;let a=s!==void 0?(o=i._$Co)==null?void 0:o[s]:i._$Cl;const r=ce(e)?void 0:e._$litDirective$;return(a==null?void 0:a.constructor)!==r&&((c=a==null?void 0:a._$AO)==null||c.call(a,!1),r===void 0?a=void 0:(a=new r(t),a._$AT(t,i,s)),s!==void 0?(i._$Co??(i._$Co=[]))[s]=a:i._$Cl=a),a!==void 0&&(e=te(t,a._$AS(t,e.values),a,s)),e}class dt{constructor(e,i){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=i}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:i},parts:s}=this._$AD,a=((e==null?void 0:e.creationScope)??Q).importNode(i,!0);Z.currentNode=a;let r=Z.nextNode(),o=0,c=0,l=s[0];for(;l!==void 0;){if(o===l.index){let h;l.type===2?h=new pe(r,r.nextSibling,this,e):l.type===1?h=new l.ctor(r,l.name,l.strings,this,e):l.type===6&&(h=new ut(r,this,e)),this._$AV.push(h),l=s[++c]}o!==(l==null?void 0:l.index)&&(r=Z.nextNode(),o++)}return Z.currentNode=Q,a}p(e){let i=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(e,s,i),i+=s.strings.length-2):s._$AI(e[i])),i++}}class pe{get _$AU(){var e;return((e=this._$AM)==null?void 0:e._$AU)??this._$Cv}constructor(e,i,s,a){this.type=2,this._$AH=m,this._$AN=void 0,this._$AA=e,this._$AB=i,this._$AM=s,this.options=a,this._$Cv=(a==null?void 0:a.isConnected)??!0}get parentNode(){let e=this._$AA.parentNode;const i=this._$AM;return i!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=i.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,i=this){e=te(this,e,i),ce(e)?e===m||e==null||e===""?(this._$AH!==m&&this._$AR(),this._$AH=m):e!==this._$AH&&e!==ee&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):lt(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==m&&ce(this._$AH)?this._$AA.nextSibling.data=e:this.T(Q.createTextNode(e)),this._$AH=e}$(e){var r;const{values:i,_$litType$:s}=e,a=typeof s=="number"?this._$AC(e):(s.el===void 0&&(s.el=de.createElement(Qe(s.h,s.h[0]),this.options)),s);if(((r=this._$AH)==null?void 0:r._$AD)===a)this._$AH.p(i);else{const o=new dt(a,this),c=o.u(this.options);o.p(i),this.T(c),this._$AH=o}}_$AC(e){let i=Oe.get(e.strings);return i===void 0&&Oe.set(e.strings,i=new de(e)),i}k(e){Le(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let s,a=0;for(const r of e)a===i.length?i.push(s=new pe(this.O(le()),this.O(le()),this,this.options)):s=i[a],s._$AI(r),a++;a<i.length&&(this._$AR(s&&s._$AB.nextSibling,a),i.length=a)}_$AR(e=this._$AA.nextSibling,i){var s;for((s=this._$AP)==null?void 0:s.call(this,!1,!0,i);e!==this._$AB;){const a=De(e).nextSibling;De(e).remove(),e=a}}setConnected(e){var i;this._$AM===void 0&&(this._$Cv=e,(i=this._$AP)==null||i.call(this,e))}}class fe{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,i,s,a,r){this.type=1,this._$AH=m,this._$AN=void 0,this.element=e,this.name=i,this._$AM=a,this.options=r,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=m}_$AI(e,i=this,s,a){const r=this.strings;let o=!1;if(r===void 0)e=te(this,e,i,0),o=!ce(e)||e!==this._$AH&&e!==ee,o&&(this._$AH=e);else{const c=e;let l,h;for(e=r[0],l=0;l<r.length-1;l++)h=te(this,c[s+l],i,l),h===ee&&(h=this._$AH[l]),o||(o=!ce(h)||h!==this._$AH[l]),h===m?e=m:e!==m&&(e+=(h??"")+r[l+1]),this._$AH[l]=h}o&&!a&&this.j(e)}j(e){e===m?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class pt extends fe{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===m?void 0:e}}class ht extends fe{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==m)}}class gt extends fe{constructor(e,i,s,a,r){super(e,i,s,a,r),this.type=5}_$AI(e,i=this){if((e=te(this,e,i,0)??m)===ee)return;const s=this._$AH,a=e===m&&s!==m||e.capture!==s.capture||e.once!==s.once||e.passive!==s.passive,r=e!==m&&(s===m||a);a&&this.element.removeEventListener(this.name,this,s),r&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var i;typeof this._$AH=="function"?this._$AH.call(((i=this.options)==null?void 0:i.host)??this.element,e):this._$AH.handleEvent(e)}}class ut{constructor(e,i,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=i,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){te(this,e)}}const $e=ne.litHtmlPolyfillSupport;$e==null||$e(de,pe),(ne.litHtmlVersions??(ne.litHtmlVersions=[])).push("3.3.3");const mt=(t,e,i)=>{const s=(i==null?void 0:i.renderBefore)??e;let a=s._$litPart$;if(a===void 0){const r=(i==null?void 0:i.renderBefore)??null;s._$litPart$=a=new pe(e.insertBefore(le(),r),r,void 0,i??{})}return a._$AI(t),a};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const G=globalThis;class x extends J{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var i;const e=super.createRenderRoot();return(i=this.renderOptions).renderBefore??(i.renderBefore=e.firstChild),e}update(e){const i=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=mt(i,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)==null||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)==null||e.setConnected(!1)}render(){return ee}}var Fe;x._$litElement$=!0,x.finalized=!0,(Fe=G.litElementHydrateSupport)==null||Fe.call(G,{LitElement:x});const we=G.litElementPolyfillSupport;we==null||we({LitElement:x});(G.litElementVersions??(G.litElementVersions=[])).push("4.2.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const bt={attribute:!0,type:String,converter:be,reflect:!1,hasChanged:Ae},vt=(t=bt,e,i)=>{const{kind:s,metadata:a}=i;let r=globalThis.litPropertyMetadata.get(a);if(r===void 0&&globalThis.litPropertyMetadata.set(a,r=new Map),s==="setter"&&((t=Object.create(t)).wrapped=!0),r.set(i.name,t),s==="accessor"){const{name:o}=i;return{set(c){const l=e.get.call(this);e.set.call(this,c),this.requestUpdate(o,l,t,!0,c)},init(c){return c!==void 0&&this.C(o,void 0,t,c),c}}}if(s==="setter"){const{name:o}=i;return function(c){const l=this[o];e.call(this,c),this.requestUpdate(o,l,t,!0,c)}}throw Error("Unsupported decorator location: "+s)};function d(t){return(e,i)=>typeof i=="object"?vt(t,e,i):((s,a,r)=>{const o=a.hasOwnProperty(r);return a.constructor.createProperty(r,s),o?Object.getOwnPropertyDescriptor(a,r):void 0})(t,e,i)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function p(t){return d({...t,state:!0,attribute:!1})}const ft=C`
  :host {
    --agpc-bg: #0b0f1a;
    --agpc-bg-alt: #0e1424;
...
`,g={shield:"M12,1L3,5V11C3,16.55 6.84,21.74 12,23C17.16,21.74 21,16.55 21,11V5L12,1Z",dashboard:"M13,3V9H21V3M13,21H21V11H13M3,21H11V15H3M3,13H11V3H3V13Z",groups:"M16.5,12A2.5,2.5 0 0,0 19,9.5A2.5,2.5 0 0,0 16.5,7A2.5,2.5 0 0,0 14,9.5A2.5,2.5 0 0,0 16.5,12M9,12A2.5,2.5 0 0,0 11.5,9.5A2.5,2.5 0 0,0 9,7A2.5,2.5 0 0,0 6.5,9.5A2.5,2.5 0 0,0 9,12M9,14C6.33,14 1,15.34 1,18V20H17V18C17,15.34 11.67,14 9,14M16.5,14C16.29,14 16.06,14 15.82,14C17.16,15 18,16.36 18,18V20H23V18C23,15.34 19.33,14 16.5,14Z",members:"M12,4A4,4 0 0,1 16,8A4,4 0 0,1 12,12A4,4 0 0,1 8,8A4,4 0 0,1 12,4M12,14C16.42,14 20,15.79 20,18V20H4V18C4,15.79 7.58,14 12,14Z",clients:"M4,6H20V16H4M20,18A2,2 0 0,0 22,16V6C22,4.89 21.1,4 20,4H4C2.89,4 2,4.89 2,6V16A2,2 0 0,0 4,18H0V20H24V18H20Z",policies:"M12,1L3,5V11C3,16.55 6.84,21.74 12,23C17.16,21.74 21,16.55 21,11V5L12,1M12,7A2,2 0 0,1 14,9C14,10.11 13.1,11 12,11A2,2 0 0,1 10,9A2,2 0 0,1 12,7M17.75,17C17.75,15.14 15.14,14 12,14C8.86,14 6.25,15.14 6.25,17V18H17.75V17Z",profiles:"M12,12A5,5 0 0,0 17,7A5,5 0 0,0 12,2A5,5 0 0,0 7,7A5,5 0 0,0 12,12M12,14C8.34,14 1,15.79 1,19.5V22H23V19.5C23,15.79 15.66,14 12,14Z",schedules:"M12,20A8,8 0 0,0 20,12A8,8 0 0,0 12,4A8,8 0 0,0 4,12A8,8 0 0,0 12,20M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22C6.47,22 2,17.5 2,12A10,10 0 0,1 12,2M12.5,7V12.25L17,14.92L16.25,16.15L11,13V7H12.5Z",services:"M12,2L1,21H23M12,6L19.53,19H4.47M11,10V14H13V10M11,16V18H13V16",overrides:"M9,3L5,6.99H8V14H10V6.99H13M16,17.01V10H14V17.01H11L15,21L19,17.01H16Z",logs:"M14,17H7V15H14M17,13H7V11H17M17,9H7V7H17M19,3H5C3.89,3 3,3.89 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V5C21,3.89 20.1,3 19,3Z",settings:"M12,15.5A3.5,3.5 0 0,1 8.5,12A3.5,3.5 0 0,1 12,8.5A3.5,3.5 0 0,1 15.5,12A3.5,3.5 0 0,1 12,15.5M19.43,12.97C19.47,12.65 19.5,12.33 19.5,12C19.5,11.67 19.47,11.34 19.43,11L21.54,9.37C21.73,9.22 21.78,8.95 21.66,8.73L19.66,5.27C19.54,5.05 19.27,4.96 19.05,5.05L16.56,6.05C16.04,5.66 15.5,5.32 14.87,5.07L14.5,2.42C14.46,2.18 14.25,2 14,2H10C9.75,2 9.54,2.18 9.5,2.42L9.13,5.07C8.5,5.32 7.96,5.66 7.44,6.05L4.95,5.05C4.73,4.96 4.46,5.05 4.34,5.27L2.34,8.73C2.21,8.95 2.27,9.22 2.46,9.37L4.57,11C4.53,11.34 4.5,11.67 4.5,12C4.5,12.33 4.53,12.65 4.57,12.97L2.46,14.63C2.27,14.78 2.21,15.05 2.34,15.27L4.34,18.73C4.46,18.95 4.73,19.03 4.95,18.95L7.44,17.94C7.96,18.34 8.5,18.68 9.13,18.93L9.5,21.58C9.54,21.82 9.75,22 10,22H14C14.25,22 14.46,21.82 14.5,21.58L14.87,18.93C15.5,18.67 16.04,18.34 16.56,17.94L19.05,18.95C19.27,19.03 19.54,18.95 19.66,18.73L21.66,15.27C21.78,15.05 21.73,14.78 21.54,14.63L19.43,12.97Z",chevronRight:"M8.59,16.58L13.17,12L8.59,7.41L10,6L16,12L10,18L8.59,16.58Z",back:"M20,11V13H8L13.5,18.5L12.08,19.92L4.16,12L12.08,4.08L13.5,5.5L8,11H20Z",plus:"M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z",sync:"M12,4V1L8,5L12,9V6A6,6 0 0,1 18,12C18,13.03 17.7,14 17.19,14.79L18.63,16.23C19.5,15 20,13.55 20,12A8,8 0 0,0 12,4M12,18A6,6 0 0,1 6,12C6,10.97 6.3,10 6.81,9.21L5.37,7.77C4.5,9 4,10.45 4,12A8,8 0 0,0 12,20V23L16,19L12,15V18Z",moon:"M17.75,4.09L15.22,6.03L16.13,9.09L13.5,7.28L10.87,9.09L11.78,6.03L9.25,4.09L12.44,4L13.5,1L14.56,4L17.75,4.09M21.25,11L19.61,12.25L20.2,14.23L18.5,13.06L16.8,14.23L17.39,12.25L15.75,11L17.81,10.95L18.5,9L19.19,10.95L21.25,11M18.97,15.95C19.8,15.87 20.69,17.05 20.16,17.8C19.84,18.25 19.5,18.67 19.08,19.07C15.17,23 8.84,23 4.94,19.07C1.03,15.17 1.03,8.83 4.94,4.93C5.34,4.53 5.76,4.17 6.21,3.85C6.96,3.32 8.14,4.21 8.06,5.04C7.79,7.9 8.75,10.87 10.95,13.06C13.14,15.26 16.1,16.22 18.97,15.95M17.33,17.97C14.5,17.81 11.7,16.64 9.53,14.5C7.36,12.31 6.2,9.5 6.04,6.68C3.23,9.82 3.34,14.64 6.35,17.66C9.37,20.67 14.19,20.78 17.33,17.97Z",dots:"M12,16A2,2 0 0,1 14,18A2,2 0 0,1 12,20A2,2 0 0,1 10,18A2,2 0 0,1 12,16M12,10A2,2 0 0,1 14,12A2,2 0 0,1 12,14A2,2 0 0,1 10,12A2,2 0 0,1 12,10M12,4A2,2 0 0,1 14,6A2,2 0 0,1 12,8A2,2 0 0,1 10,6A2,2 0 0,1 12,4Z",laptop:"M4,6H20V16H4M20,18A2,2 0 0,0 22,16V6C22,4.89 21.1,4 20,4H4C2.89,4 2,4.89 2,6V16A2,2 0 0,0 4,18H0V20H24V18H20Z",clock:"M12,20A8,8 0 0,0 20,12A8,8 0 0,0 12,4A8,8 0 0,0 4,12A8,8 0 0,0 12,20M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22C6.47,22 2,17.5 2,12A10,10 0 0,1 12,2M12.5,7V12.25L17,14.92L16.25,16.15L11,13V7H12.5Z",category:"M4,4H10V10H4V4M20,4V10H14V4H20M14,14H20V20H14V14M4,14H10V20H4V14Z",domain:"M16.36,14C16.44,13.34 16.5,12.68 16.5,12C16.5,11.32 16.44,10.66 16.36,10H19.74C19.9,10.64 20,11.31 20,12C20,12.69 19.9,13.36 19.74,14M14.59,19.56C15.19,18.45 15.65,17.25 15.97,16H18.92C17.96,17.65 16.43,18.93 14.59,19.56M14.34,14H9.66C9.56,13.34 9.5,12.68 9.5,12C9.5,11.32 9.56,10.65 9.66,10H14.34C14.43,10.65 14.5,11.32 14.5,12C14.5,12.68 14.43,13.34 14.34,14M12,19.96C11.17,18.76 10.5,17.43 10.09,16H13.91C13.5,17.43 12.83,18.76 12,19.96M8,8H5.08C6.03,6.34 7.57,5.06 9.4,4.44C8.8,5.55 8.35,6.75 8,8M5.08,16H8C8.35,17.25 8.8,18.45 9.4,19.56C7.57,18.93 6.03,17.65 5.08,16M4.26,14C4.1,13.36 4,12.69 4,12C4,11.31 4.1,10.64 4.26,10H7.64C7.56,10.66 7.5,11.32 7.5,12C7.5,12.68 7.56,13.34 7.64,14M12,4.03C12.83,5.23 13.5,6.57 13.91,8H10.09C10.5,6.57 11.17,5.23 12,4.03M18.92,8H15.97C15.65,6.75 15.19,5.55 14.59,4.44C16.43,5.07 17.96,6.34 18.92,8M12,2C6.47,2 2,6.5 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z"};var yt=Object.defineProperty,_t=Object.getOwnPropertyDescriptor,he=(t,e,i,s)=>{for(var a=s>1?void 0:s?_t(e,i):e,r=t.length-1,o;r>=0;r--)(o=t[r])&&(a=(s?o(e,i,a):o(a))||a);return s&&a&&yt(e,i,a),a};let Y=class extends x{constructor(){super(...arguments),this._collapsedGroups=new Set}_icon(t,e=20){return N`<svg viewBox="0 0 24 24" width="${e}" height="${e}"><path fill="currentColor" d="${t}"></path></svg>`}_ownerFor(t){const e=this.state.members.find(s=>s.client_names.includes(t.name));if(e)return e.name;const i=this.state.groups.find(s=>s.client_names.includes(t.name));return i?i.name:"Unassigned"}_toggleGroup(t){const e=new Set(this._collapsedGroups);e.has(t)?e.delete(t):e.add(t),this._collapsedGroups=e}_rowFor(t){var s;const e=t.assigned_policy_ids.length>0,i=e?this.state.policies.find(a=>a.id===t.assigned_policy_ids[0]):void 0;return{client:t,owner:this._ownerFor(t),restricted:e,currentPolicy:i?i.name:"Default",nextChange:((s=i==null?void 0:i.time_schedule)==null?void 0:s.time_to)||"-"}}_groupedClients(){const t=new Set,e=[];for(const s of this.state.groups){const a=s.client_names.map(r=>this.state.clients.find(o=>o.name===r)).filter(Boolean).map(r=>this._rowFor(r));a.length!==0&&(a.forEach(r=>t.add(r.client.name)),e.push({name:s.name,groupId:s.id,rows:a,collapsed:this._collapsedGroups.has(s.id)}))}const i=this.state.clients.filter(s=>!t.has(s.name)).map(s=>this._rowFor(s));return i.length>0&&e.push({name:"Ungrouped",groupId:null,rows:i,collapsed:this._collapsedGroups.has("__ungrouped__")}),e}_clientRows(){return this.state.clients.map(t=>{var a;const e=t.assigned_policy_ids.length>0,i=e?this.state.policies.find(r=>r.id===t.assigned_policy_ids[0]):void 0;let s="-";return(a=i==null?void 0:i.time_schedule)!=null&&a.time_to&&(s=i.time_schedule.time_to),{client:t,owner:this._ownerFor(t),restricted:e,currentPolicy:i?i.name:"Default",nextChange:s}})}_blockedCategoryRules(){const t=new Map;for(const e of this.state.policies)for(const i of e.rules)i.rule_type==="category"&&i.action==="block"&&t.set(i.target,(t.get(i.target)||0)+1);for(const e of this.state.profiles)for(const i of e.rules)i.rule_type==="category"&&i.action==="block"&&t.set(i.target,(t.get(i.target)||0)+1);return Array.from(t.entries()).map(([e,i])=>({target:e,count:i})).sort((e,i)=>i.count-e.count).slice(0,5)}_blockedDomainRules(){const t=[];for(const e of this.state.policies)for(const i of e.rules)i.rule_type==="domain"&&i.action==="block"&&t.push({target:i.target,source:e.name});for(const e of this.state.profiles)for(const i of e.rules)i.rule_type==="domain"&&i.action==="block"&&t.push({target:i.target,source:e.name});return t.slice(0,6)}_totalRules(){const t=this.state.policies.reduce((i,s)=>i+s.rules.length,0),e=this.state.profiles.reduce((i,s)=>i+s.rules.length,0);return t+e}render(){if(!this.state)return n``;const t=this._clientRows(),e=t.filter(r=>r.restricted).length,i=this.state.policies.filter(r=>r.rules.length>0||r.profile_id),s=this._blockedCategoryRules(),a=this._blockedDomainRules();return n`
      <div class="stat-grid">
        ...
        <div class="stat-card">
          <div class="stat-top">
            ...
            <div class="stat-icon green">${this._icon(g.policies)}</div>
          </div>
        ...
        <div class="stat-card">
          <div class="stat-top">
            ...
            <div class="stat-icon yellow">${this._icon(g.shield)}</div>
          </div>
        ...
        <div class="stat-card">
          <div class="stat-top">
            ...
            <div class="stat-icon purple">${this._icon(g.clock)}</div>
          </div>
      ...
      <div class="card clients-card">
        ...
        ${t.length===0?n`<div class="empty-state">No clients configured yet.</div>`:this._groupedClients().map(r=>n`
              <div class="group-section">
                <div class="group-header" @click=${()=>this._toggleGroup(r.groupId??"__ungrouped__")}>
                  <span class="group-chevron">${r.collapsed?"▸":"▾"}</span>
                  <span class="group-name">${r.name}</span>
                  <span class="group-count">${r.rows.length}</span>
                </div>
                ${r.collapsed?"":n`
                <table class="table">
                  <thead>
                      ...
                      <tr class="clickable" @click=${()=>{var c;return(c=this.onNavigate)==null?void 0:c.call(this,"client-detail",o.client)}}>
                        <td>
                          <div class="client-cell">
                            <span class="client-icon">${this._icon(g.laptop,16)}</span>
                            <div>
      ...
      <div class="bottom-grid">
        <div class="card mini-card">
          ...
          <div class="mini-body">
            <div class="mini-icon blue">${this._icon(g.schedules,22)}</div>
            <div>
        ...
        <div class="card mini-card">
          ...
          ${s.length===0?n`<div class="empty-state">No blocked categories yet.</div>`:n`
                <ul class="rank-list">
                  ${s.map(r=>n`
                      <li>
                        <span class="rank-icon">${this._icon(g.category,16)}</span>
        ...
        <div class="card mini-card">
          ...
          ${a.length===0?n`<div class="empty-state">No blocked domains yet.</div>`:n`
                <ul class="rank-list">
                  ${a.map(r=>n`
                      <li>
                        <span class="rank-icon">${this._icon(g.domain,16)}</span>
                        <span class="rank-label">${r.target}</span>
    ...
    <div class="page">
      ...
      <section class="hero card">
        <div class="device-hero-icon">${this._icon(g.laptop,34)}</div><div class="hero-main"><div class="title-line"><h1>${this.client.name}</h1><span class="pill green">Online</span></div><div class="hero-line">${this.client.ids[0]||"No IP"} <span>•</span> Primary device</div><div class="hero-sub">AdGuard Client: ${this.client.ids[1]||this.client.name}</div></div>
      ...
      <div class="tabs">${["general","policies","rules","overrides","activity"].map(o=>n`<button class="tab ${this._tab===o?"active":""}" @click=${()=>this._tab=o}>${o[0].toUpperCase()+o.slice(1)}</button>`)}</div>
      <div class="content-grid"><main class="main-column">
        ${this._tab==="general"?this._general(e,i,s):m}
        ${this._tab==="policies"?this._policiesView(t):m}
        ${this._tab==="rules"?this._rulesView():m}
        ${this._tab==="overrides"?this._overridesView():m}
        ${this._tab==="activity"?this._activityView():m}
        ${this._tab==="policies"?n`<section class="card preview-card"><div class="section-head"><h2>Policy Preview <span>(Now)</span></h2><button class="btn small">◉ Preview Full Details</button></div><div class="preview-grid"><div><small>Effective Mode</small><strong class="pill purple">${this._mode(t)}</strong></div><div><small>Active Policy</small><strong>${(t==null?void 0:t.name)||"Default"}</strong><span>${this._schedule(t)}</span></div><div><small>Matching Conditions</small><strong>✓ Time: ${new Date().toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",hour12:!1})}</strong><span>✓ Day: ${new Date().toLocaleDateString([],{weekday:"long"})}</span></div></div></section>`:m}
      ...
      <aside class="query-panel card"><div class="query-head"><div><h2>Service / Domain History</h2><small>Latest DNS queries for this client</small></div><div class="query-actions"><select class="compact-select"><option>Last 24 hours</option></select><button class="icon-btn" @click=${this._loadQueryLog}>↻</button></div></div>
        ...
        <div class="query-table-wrap"><table class="table query-table"><thead><tr><th>TIME</th><th>DOMAIN / SERVICE</th><th>TYPE</th><th>RESPONSE</th><th>STATUS</th><th>DETAILS</th></tr></thead><tbody>${this._logs().slice(0,12).map(o=>{var c;return n`<tr><td class="time">${this._time(o.time)}</td><td><div class="domain-cell">${this._serviceIcon(S(o))}<strong>${S(o)||"—"}</strong></div></td><td>${((c=o.question)==null?void 0:c.type)||"A"}</td><td class="response">${this._response(o)}</td><td>${this._blocked(o)?n`<span class="pill red">Blocked</span>`:n`<span class="pill green">Processed</span>`}</td><td class="details">${this._blocked(o)?"✕ Blocklist":this._ms(o)}</td></tr>`})}</tbody></table>${this._queryLoading&&!this._queryLogs.length?n`<div class="empty">Loading query log…</div>`:m}${this._queryError?n`<div class="query-error">${this._queryError}</div>`:m}${!this._queryLoading&&!this._logs().length?n`<div class="empty">No DNS queries found for this client.</div>`:m}</div>
    ...
    ${this._showDeleteConfirm?n`<div class="modal-scrim" @click=${()=>this._showDeleteConfirm=!1}><div class="modal" @click=${o=>o.stopPropagation()}><h3>Delete client "${this.client.name}"?</h3><p>This cannot be undone.</p><div class="modal-actions"><button class="btn" @click=${()=>this._showDeleteConfirm=!1}>Cancel</button><button class="btn danger" @click=${this._deleteClient}>Delete</button></div></div></div>`:m}
    ${this._topDetail?n`<div class="modal-scrim" @click=${()=>this._topDetail=null}><div class="modal detail-modal" @click=${o=>o.stopPropagation()}><h3>${this._topDetail.key}</h3><div class="detail-grid"><div class="detail-row"><span>Total Requests</span><strong>${this._topDetail.requests}</strong></div><div class="detail-row"><span>Processed</span><strong class="green-text">${this._topDetail.processed} <small>(${this._topDetail.requests?Math.round(this._topDetail.processed/this._topDetail.requests*100):0}%)</small></strong></div><div class="detail-row"><span>Blocked</span><strong class="red-text">${this._topDetail.blocked} <small>(${this._topDetail.requests?Math.round(this._topDetail.blocked/this._topDetail.requests*100):0}%)</small></strong></div><div class="detail-row"><span>Avg Response</span><strong>${this._topDetail.processed?`${Math.round(this._topDetail.totalMs/this._topDetail.processed)} ms`:"—"}</strong></div>${this._topDetail.service?n`<div class="detail-row"><span>Service ID</span><strong class="mono">${this._topDetail.service.id}</strong></div><div class="detail-row"><span>Categories</span><strong>${((r=this._topDetail.service.categories)==null?void 0:r.join(", "))||"—"}</strong></div>`:n`<div class="detail-row"><span>Full Domain</span><strong class="mono">${this._topDetail.key}</strong></div>`}</div><div class="modal-actions"><button class="btn" @click=${()=>this._topDetail=null}>Close</button></div></div></div>`:m}`}_general(t,e,i){return n`<section class="card section-card"><div class="section-head"><h2>Client Identity</h2><button class="btn small" @click=${this._saveIdentity}>Save</button></div><div class="form-grid"><label>Name<input class="field" .value=${this.client.name} readonly></label><label>IP Address<input class="field" .value=${this.client.ids[0]||""} readonly></label><label>AdGuard Client<input class="field" .value=${this.client.ids[1]||""} readonly></label><label>Group<input class="field" .value=${(t==null?void 0:t.name)||"—"} readonly></label><label>Member<input class="field" .value=${(e==null?void 0:e.name)||"—"} readonly></label><label>Profile<input class="field" .value=${(i==null?void 0:i.name)||"—"} readonly></label></div></section>`}_policiesView(t){return n`<section class="card section-card"><div class="section-head"><div><h2>Assigned Policies</h2><small>Policies applied to this client (top to bottom = priority)</small></div><button class="btn primary small">＋ Assign Policy</button></div><table class="table"><thead><tr><th>PRIORITY</th><th>POLICY</th><th>SCHEDULE</th><th>STATUS</th><th>ACTIONS</th></tr></thead><tbody>${this._policies.map((e,i)=>n`<tr class=${e.id===(t==null?void 0:t.id)?"active-row":""}><td>${i+1}</td><td><strong>☾ ${e.name}</strong><span class="pill purple mode-pill">${this._mode(e)}</span></td><td>${this._schedule(e)}<small>${this._days(e)}</small></td><td><span class="pill ${this._policyActive(e)?"green":"gray"}">${this._policyActive(e)?"ACTIVE":"INACTIVE"}</span></td><td>⋮</td></tr>`)}</tbody></table>${this._policies.length?n`<div class="info-note">ⓘ Policies are evaluated from top to bottom. The first matching policy is applied unless overridden.</div>`:n`<div class="empty">No policies assigned.</div>`}</section>`}_rulesView(){const t=this._policies.flatMap(e=>e.rules.map(i=>({...i,policy:e.name})));return n`<section class="card section-card"><div class="section-head"><div><h2>Client Rules</h2><small>Rules inherited from assigned policies</small></div><button class="btn primary small">＋ Add Rule</button></div><table class="table"><thead><tr><th>POLICY</th><th>TYPE</th><th>TARGET</th><th>ACTION</th></tr></thead><tbody>${t.map(e=>n`<tr><td>${e.policy}</td><td>${e.rule_type}</td><td class="mono">${e.target}</td><td><span class="pill ${e.action==="allow"?"green":"red"}">${e.action.toUpperCase()}</span></td></tr>`)}</tbody></table>${t.length?m:n`<div class="empty">No rules defined.</div>`}</section>`}_overridesView(){const t=this.state.overrides.filter(e=>e.target_type==="client"&&e.target===this.client.name&&(!e.expires||new Date(e.expires).getTime()>Date.now()));return n`<section class="card section-card"><div class="section-head"><h2>Overrides (${t.length})</h2><button class="btn primary small">＋ New Override</button></div>${t.length?t.map(e=>n`<div class="override-row"><strong>${e.action.replaceAll("_"," ")}</strong><span>${e.expires||"No expiry"}</span></div>`):n`<div class="empty">No active overrides.</div>`}</section>`}_activityView(){return n`<section class="card section-card"><div class="section-head"><h2>Activity</h2><button class="btn small" @click=${this._loadQueryLog}>↻ Refresh</button></div><div class="activity-summary"><strong>${this._queryLogs.length}</strong><span>recent DNS queries loaded from AdGuard Home</span></div></section>`}_topTable(t,e,i){return n`<section class="card section-card top-table"><div class="section-head"><h2>${t} <span>(Last 24 hours)</span></h2></div><table class="table"><thead><tr><th>${i?"SERVICE":"DOMAIN"}</th><th>REQUESTS</th><th>PROCESSED</th><th>BLOCKED</th></tr></thead><tbody>${e.map(([s,a])=>{const r=a.requests?Math.round(a.processed/a.requests*100):0,o=a.requests?Math.round(a.blocked/a.requests*100):0;return n`<tr><td><div class="domain-cell top-cell" @click=${()=>this._topDetail={key:s,requests:a.requests,processed:a.processed,blocked:a.blocked,totalMs:a.totalMs,service:a.service||null}}>${i&&a.service?this._serviceIcon(a.service.domains[0],20):m}<strong>${s}</strong></div></td><td>${a.requests}</td><td class="processed">${a.processed||"—"}<small>${r}%</small></td><td class="blocked-count">${a.blocked||"—"}<small>${o}%</small></td></tr>`})}</tbody></table>${e.length?m:n`<div class="empty">No query data yet.</div>`}</section>`}async _saveIdentity(){var t;await this.hass.callWS({type:"adguard_pc/clients/update",client:this.client}),(t=this.onStateChanged)==null||t.call(this)}async _deleteClient(){var t,e;await this.hass.callWS({type:"adguard_pc/clients/delete",client_id:this.client.name}),this._showDeleteConfirm=!1,(t=this.onStateChanged)==null||t.call(this),(e=this.onNavigate)==null||e.call(this,"clients")}};y.styles=[se,C`
  ...
  `];w([d({attribute:!1})],y.prototype,"hass",2);w([d({attribute:!1})],y.prototype,"state",2);w([d({attribute:!1})],y.prototype,"client",2);w([d({type:Object})],y.prototype,"onNavigate",2);w([d({type:Object})],y.prototype,"onStateChanged",2);w([p()],y.prototype,"_tab",2);w([p()],y.prototype,"_queryLogs",2);w([p()],y.prototype,"_queryLoading",2);w([p()],y.prototype,"_queryLive",2);w([p()],y.prototype,"_queryError",2);w([p()],y.prototype,"_querySearch",2);w([p()],y.prototype,"_queryOldest",2);w([p()],y.prototype,"_queryFullyLoaded",2);w([p()],y.prototype,"_selectedPolicyId",2);w([p()],y.prototype,"_showDeleteConfirm",2);w([p()],y.prototype,"_topDetail",2);y=w([L("client-view")],y);var kt=Object.defineProperty,At=Object.getOwnPropertyDescriptor,$=(t,e,i,s)=>{for(var a=s>1?void 0:s?At(e,i):e,r=t.length-1,o;r>=0;r--)(o=t[r])&&(a=(s?o(e,i,a):o(a))||a);return s&&a&&kt(e,i,a),a};let f=class extends x{constructor(){super(...arguments),this.narrow=!1,this._tab="general",this._draft=null,this._dirty=!1,this._showDeleteConfirm=!1,this._showAddRule=!1,this._showAddException=!1,this._newRuleTarget="",this._newRuleAction="block",this._newRuleType="domain",this._newExceptionTarget="",this._newExceptionType="domain",this._onNameInput=t=>this._markDirty({...this._p,name:t.target.value}),this._onDescriptionInput=t=>this._markDirty({...this._p,description:t.target.value}),this._onPriorityInput=t=>this._markDirty({...this._p,priority:Number(t.target.value||0)}),this._setPriority=t=>this._markDirty({...this._p,priority:t}),this._onProfileChange=t=>this._markDirty({...this._p,profile_id:t.target.value||null}),this._onEnabledChange=t=>this._markDirty({...this._p,enabled:t.target.checked}),this._onTagKeydown=t=>{t.key==="Enter"&&(t.preventDefault(),this._addTagFromInput())},this._removeTag=t=>this._markDirty({...this._p,tags:(this._p.tags||[]).filter(e=>e!==t)}),this._clearSchedule=async()=>this._persist({...this._p,time_schedule:null})}updated(t){t.has("policy")&&(this._draft=this._clonePolicy(this.policy),this._dirty=!1)}get _p(){return this._draft||this.policy}render(){return this.policy?n`
      <div class="page">
        ${this._renderHeader()}
        ${this._renderTabs()}
        <div class="content">
        ...
        <div class="title-row">
          <div>
            <div class="title-line">
              ...
              <span class="status ${this._p.enabled!==!1?"on":"off"}">${this._p.enabled!==!1?"Enabled":"Disabled"}</span>
            </div>
          ...
          <div class="header-actions">
            ...
            <button class="icon-btn" aria-label="Delete" @click=${()=>this._showDeleteConfirm=!0}>
              <span class="trash">⌫</span>
            </button>
          </div>
        </div>
      </div>
    `}_renderTabs(){var e;const t=[["general","General"],["rules",`Rules${this._p.rules.length?` (${this._p.rules.length})`:""}`],["schedule","Schedule"],["calendar","Calendar Condition"],["exceptions",`Exceptions${(e=this._p.exceptions)!=null&&e.length?` (${this._p.exceptions.length})`:""}`],["preview","Preview"]];return n`
      <nav class="tabs" aria-label="Policy sections">
        ${t.map(([i,s])=>n`
          <button class=${this._tab===i?"tab active":"tab"} @click=${()=>this._tab=i}>${s}</button>
        `)}
      </nav>
    `}_renderGeneral(){var e;const t=this._getAppliesTo();return n`
      <div class="grid">
        <section class="card">
            ...
            <div class="form-row three">
              ...
              <div>
                ...
                <select class="select" .value=${this._p.profile_id||""} @change=${this._onProfileChange}>
                  ...
                  ${this.state.profiles.map(i=>n`<option value=${i.id}>${i.name}</option>`)}
                </select>
              </div>
              <div>
                <label>Status</label>
        ...
        <section class="card">
          ...
          <div class="card-body">
            ...
            <div class="assignment-grid">
              <div><span class="eyebrow">Groups</span><div class="chip-list">${this._getAssignedGroups().length?this._getAssignedGroups().map(i=>n`<span class="chip">${i}</span>`):n`<span class="muted">None</span>`}</div></div>
              <div><span class="eyebrow">Members</span><div class="chip-list">${this._getAssignedMembers().length?this._getAssignedMembers().map(i=>n`<span class="chip">${i}</span>`):n`<span class="muted">None</span>`}</div></div>
              <div><span class="eyebrow">Clients</span><div class="chip-list">${this._getAssignedClients().length?this._getAssignedClients().map(i=>n`<span class="chip">${i}</span>`):n`<span class="muted">None</span>`}</div></div>
            </div>
          </div>
        </section>
        ...
        <section class="card">
          ...
          <div class="card-body">
            <div class="chip-list editable">
              ${(this._p.tags||[]).map(i=>n`<span class="chip">${i}<button @click=${()=>this._removeTag(i)}>×</button></span>`)}
            </div>
    ...
    `}_renderRules(){return n`
      <section class="card">
        ...
        <div class="card-body">
          ...
          `:n`<div class="empty-box">No rules defined. This policy currently contributes no explicit domain, service or category rules.</div>`}
        </div>
      </section>
    ...
    `}_renderRuleForm(t){return n`
      <div class="inline-form">
        <div><label>Type</label><select class="select" .value=${this._newRuleType} @change=${e=>this._newRuleType=e.target.value}>
          <option value="domain">Domain</option><option value="service">Service</option><option value="category">Category</option>
        </select></div>
        <div class="grow"><label>${t?"Allowed target":"Target"}</label><input class="input" .value=${t?this._newExceptionTarget:this._newRuleTarget} @input=${e=>t?this._newExceptionTarget=e.target.value:this._newRuleTarget=e.target.value} placeholder=${t?"whatsapp.com":"example.com"} /></div>
        ${t?n``:n`<div><label>Action</label><select class="select" .value=${this._newRuleAction} @change=${e=>this._newRuleAction=e.target.value}><option value="block">Block</option><option value="allow">Allow</option></select></div>`}
    ...
    `}_renderSchedule(){const t=this._p.time_schedule,e=["mon","tue","wed","thu","fri","sat","sun"];return n`
      <section class="card">
        <div class="card-title row-between"><span>Schedule</span>${t?n`<button class="text-btn danger-text" @click=${this._removeSchedule}>Remove</button>`:""}</div>
        <div class="card-body">
          ...
          ${t?n`
            <div class="form-grid">
              <div class="full"><label>Days</label><div class="day-chips">${e.map(i=>n`<button class=${t.days.includes(i)?"day active":"day"} @click=${()=>this._toggleScheduleDay(i)}>${i.slice(0,1).toUpperCase()+i.slice(1)}</button>`)}</div></div>
          ...
          `:n`<div class="empty-box">This policy is active at all times unless a calendar condition prevents it.</div>`}
        </div>
      </section>
    `}_renderCalendar(){const t=this._p.calendar_condition;return n`
      <section class="card">
        <div class="card-title row-between"><span>Calendar Condition</span>${t?n`<button class="text-btn danger-text" @click=${this._removeCalendar}>Remove</button>`:""}</div>
        <div class="card-body">
          ${t?n`
            <div class="form-grid">
              <div class="full"><label>Calendar entity</label><select class="select" .value=${t.calendar_entity||""} @change=${e=>this._updateCalendar("calendar_entity",e.target.value)}>
                ...
                ${this.state.calendar_entities.map(e=>n`<option value=${e}>${e}</option>`)}
              </select></div>
    ...
    `}_renderExceptions(){const t=this._p.exceptions||[];return n`
      <section class="card">
        ...
        <div class="card-body">
          ...
          ${t.length?n`<table class="data-table"><thead><tr><th>Type</th><th>Allowed target</th><th></th></tr></thead><tbody>
            ${t.map((e,i)=>n`<tr><td><span class="badge">${e.rule_type}</span></td><td class="mono">${e.target}</td><td class="end"><button class="text-btn danger-text" @click=${()=>this._removeException(i)}>Remove</button></td></tr>`)}
          </tbody></table>`:n`<div class="empty-box">No policy-specific exceptions.</div>`}
        </div>
      </section>
    `}_renderPreview(){this._p.time_schedule;const t=this._p.rules,e=this._p.exceptions||[],i=[...this._getAssignedGroups(),...this._getAssignedMembers(),...this._getAssignedClients()];return n`
      <div class="preview-grid">
        ...
        <section class="card">
          ...
          <div class="card-body">
            ${t.length?n`<div class="rule-summary">${t.map(s=>n`<div class="rule-line"><span class=${s.action==="block"?"dot red":"dot green"}></span><span class="badge">${s.rule_type}</span><span class="mono">${s.target}</span><b class=${s.action==="block"?"red":"green"}>${s.action.toUpperCase()}</b></div>`)}</div>`:n`<div class="empty-box">No explicit rules.</div>`}
            ${e.length?n`<div class="exception-preview"><div class="eyebrow">Exceptions</div>${e.map(s=>n`<div class="rule-line"><span class="dot green"></span><span class="mono">${s.target}</span><b class="green">ALLOW</b></div>`)}</div>`:""}
          </div>
        </section>
  ...
  `;$([d({attribute:!1})],f.prototype,"hass",2);$([d({attribute:!1})],f.prototype,"state",2);$([d({attribute:!1})],f.prototype,"policy",2);$([d({type:Boolean})],f.prototype,"narrow",2);$([d({type:Object})],f.prototype,"onNavigate",2);$([d({type:Object})],f.prototype,"onStateChanged",2);$([p()],f.prototype,"_tab",2);$([p()],f.prototype,"_draft",2);$([p()],f.prototype,"_dirty",2);$([p()],f.prototype,"_showDeleteConfirm",2);$([p()],f.prototype,"_showAddRule",2);$([p()],f.prototype,"_showAddException",2);$([p()],f.prototype,"_newRuleTarget",2);$([p()],f.prototype,"_newRuleAction",2);$([p()],f.prototype,"_newRuleType",2);$([p()],f.prototype,"_newExceptionTarget",2);$([p()],f.prototype,"_newExceptionType",2);f=$([L("policy-view")],f);function Lt(t){return t?t===1?"1 assignment":`${t} assignments`:"No groups, members or clients assigned"}var St=Object.defineProperty,Mt=Object.getOwnPropertyDescriptor,q=(t,e,i,s)=>{for(var a=s>1?void 0:s?Mt(e,i):e,r=t.length-1,o;r>=0;r--)(o=t[r])&&(a=(s?o(e,i,a):o(a))||a);return s&&a&&St(e,i,a),a};let P=class extends x{constructor(){super(...arguments),this.narrow=!1,this._selectedTarget="",this._selectedTargetType="client",this._selectedAction="allow_all",this._selectedDuration="30"}render(){return this.state?(this._selectedTargetType==="client"?this.state.clients:this.state.members,n`
      <!-- New Override Form -->
      <ha-card>
        ...
        <div class="card-content">
          ...
          >
            ${this._selectedTargetType==="client"?this.state.clients.map(t=>n`<ha-list-item value="${t.name}">${t.name}</ha-list-item>`):this.state.members.map(t=>n`<ha-list-item value="${t.name}">${t.name}</ha-list-item>`)}
          </ha-select>
      ...
      <ha-card>
        ...
        <div class="card-content">
          ${this.state.overrides.length===0?n`<p class="empty">No active overrides</p>`:n`
    ...
    `):n``}async _applyOverride(){var t,e;if(this._selectedTarget)try{await this.hass.callWS({type:"adguard_pc/overrides/set",target:this._selectedTarget,target_type:this._selectedTargetType,action:this._selectedAction,duration_minutes:parseInt(this._selectedDuration,10)}),this._selectedTarget="",(t=this.onStateChanged)==null||t.call(this),(e=this.onNavigate)==null||e.call(this,"override")}catch(i){console.error("Failed to set override:",i)}}async _clearOverride(t){var e,i;try{await this.hass.callWS({type:"adguard_pc/overrides/clear",override_id:t}),(e=this.onStateChanged)==null||e.call(this),(i=this.onNavigate)==null||i.call(this,"override")}catch(s){console.error("Failed to clear override:",s)}}};P.styles=C`
    ha-card {
      margin-bottom: 8px;
    }
    .card-header {
  ...
  `;q([d({attribute:!1})],P.prototype,"hass",2);q([d({attribute:!1})],P.prototype,"state",2);q([d({type:Boolean})],P.prototype,"narrow",2);q([d({type:Object})],P.prototype,"onNavigate",2);q([d({type:Object})],P.prototype,"onStateChanged",2);q([p()],P.prototype,"_selectedTarget",2);q([p()],P.prototype,"_selectedTargetType",2);q([p()],P.prototype,"_selectedAction",2);q([p()],P.prototype,"_selectedDuration",2);P=q([L("override-view")],P);var Pt=Object.defineProperty,Tt=Object.getOwnPropertyDescriptor,R=(t,e,i,s)=>{for(var a=s>1?void 0:s?Tt(e,i):e,r=t.length-1,o;r>=0;r--)(o=t[r])&&(a=(s?o(e,i,a):o(a))||a);return s&&a&&Pt(e,i,a),a};let E=class extends x{constructor(){super(...arguments),this.narrow=!1,this._showDeleteConfirm=!1,this._showAddClient=!1}render(){return this.group?n`
      <ha-card>
        <div class="card-header">
      ...
      ${this._showAddClient?n`
        <div class="modal-scrim" @click=${()=>this._showAddClient=!1}></div>
        <div class="modal">
          <div class="modal-head"><h3>Add Client to group</h3></div>
          <div class="modal-body">
            ${this.state.clients.filter(t=>!this.group.client_names.includes(t.name)).length===0?n`<p class="empty">No available clients</p>`:this.state.clients.filter(t=>!this.group.client_names.includes(t.name)).map(t=>n`
                    <div class="modal-list-item" @click=${()=>{this._addClient(t.name),this._showAddClient=!1}}>
                      <span>${t.name}</span>
      ...
      <ha-card>
        ...
        <div class="card-content">
          ${this.group.member_names.length===0?n`<p class="empty">No members assigned</p>`:""}
          ${this.group.member_names.map(t=>n`
              <div class="list-item">
          ...
          <div class="add-row">
            <ha-select label="Add member" .value=${""}
              ...
              >
                ${this.state.members.filter(t=>!this.group.member_names.includes(t.name)).map(t=>n`<ha-list-item value="${t.name}">${t.name}</ha-list-item>`)}
              </ha-select>
          </div>
        </div>
      </ha-card>
      ...
      <ha-card>
        ...
        <div class="card-content">
          ${this.group.client_names.length===0?n`<p class="empty">No clients assigned</p>`:""}
          ${this.group.client_names.map(t=>n`
              <div class="list-item client-row">
                <span class="item-text client-link" @click=${()=>{var e;return(e=this.onNavigate)==null?void 0:e.call(this,"client-detail",this.state.clients.find(i=>i.name===t))}}>
                  ${t}
                  <ha-icon .path=${"M8.59,16.58L13.17,12L8.59,7.41L10,6L16,12L10,18L8.59,16.58Z"}></ha-icon>
                </span>
                <ha-icon-button label="Remove"
      ...
      <ha-card>
        ...
        <div class="card-content">
          ${this.group.assigned_policy_ids.length===0?n`<p class="empty">No policies assigned</p>`:""}
          ${this.group.assigned_policy_ids.map(t=>{const e=this.state.policies.find(i=>i.id===t);return n`
                <div class="list-item">
          ...
          <div class="add-row">
            ...
            >
              ${this.state.policies.filter(t=>!this.group.assigned_policy_ids.includes(t.id)).map(t=>n`<ha-list-item value="${t.id}">${t.name}</ha-list-item>`)}
            </ha-select>
          </div>
        </div>
      </ha-card>
    `:n``}_handleDeleteDialog(){this._showDeleteConfirm=!1}async _addMember(t){var i;if(!t||this.group.member_names.includes(t))return;const e={...this.group,member_names:[...this.group.member_names,t]};await this.hass.callWS({type:"adguard_pc/groups/update",group:e}),(i=this.onStateChanged)==null||i.call(this)}async _removeMember(t){var i;const e={...this.group,member_names:this.group.member_names.filter(s=>s!==t)};await this.hass.callWS({type:"adguard_pc/groups/update",group:e}),(i=this.onStateChanged)==null||i.call(this)}async _addClient(t){var i;if(!t||this.group.client_names.includes(t))return;const e={...this.group,client_names:[...this.group.client_names,t]};await this.hass.callWS({type:"adguard_pc/groups/update",group:e}),(i=this.onStateChanged)==null||i.call(this)}async _removeClient(t){var i;const e={...this.group,client_names:this.group.client_names.filter(s=>s!==t)};await this.hass.callWS({type:"adguard_pc/groups/update",group:e}),(i=this.onStateChanged)==null||i.call(this)}async _addPolicy(t){var i;if(!t||this.group.assigned_policy_ids.includes(t))return;const e={...this.group,assigned_policy_ids:[...this.group.assigned_policy_ids,t]};await this.hass.callWS({type:"adguard_pc/groups/update",group:e}),(i=this.onStateChanged)==null||i.call(this)}async _removePolicy(t){var i;const e={...this.group,assigned_policy_ids:this.group.assigned_policy_ids.filter(s=>s!==t)};await this.hass.callWS({type:"adguard_pc/groups/update",group:e}),(i=this.onStateChanged)==null||i.call(this)}async _deleteGroup(){var t,e;await this.hass.callWS({type:"adguard_pc/groups/delete",group_id:this.group.id}),this._showDeleteConfirm=!1,(t=this.onStateChanged)==null||t.call(this),(e=this.onNavigate)==null||e.call(this,"dashboard")}};E.styles=C`
  ...
  `;R([d({attribute:!1})],E.prototype,"hass",2);R([d({attribute:!1})],E.prototype,"state",2);R([d({attribute:!1})],E.prototype,"group",2);R([d({type:Boolean})],E.prototype,"narrow",2);R([d({type:Object})],E.prototype,"onNavigate",2);R([d({type:Object})],E.prototype,"onStateChanged",2);R([p()],E.prototype,"_showDeleteConfirm",2);R([p()],E.prototype,"_showAddClient",2);E=R([L("group-view")],E);var Dt=Object.defineProperty,Et=Object.getOwnPropertyDescriptor,_=(t,e,i,s)=>{for(var a=s>1?void 0:s?Et(e,i):e,r=t.length-1,o;r>=0;r--)(o=t[r])&&(a=(s?o(e,i,a):o(a))||a);return s&&a&&Dt(e,i,a),a};const Re=()=>new Date(Date.now()-24*60*60*1e3).toISOString(),je={trash:"M19,4H15.5L14.5,3H9.5L8.5,4H5V6H19M6,19A2,2 0,0,0 8,21H16A2,2 0,0,0 18,19V7H6V19Z",refresh:"M17.65,6.35C16.2,4.9 14.21,4 12,4C7.58,4 4.01,7.58 4.01,12C4.01,16.42 7.58,20 12,20C15.73,20 18.84,17.45 19.73,14H17.65C16.83,16.33 14.61,18 12,18C8.69,18 6,15.31 6,12C6,8.69 8.69,6 12,6C13.66,6 15.14,6.69 16.22,7.78L13,11H20V4L17.65,6.35Z"};let v=class extends x{constructor(){super(...arguments),this.narrow=!1,this._newException="",this._showDeleteConfirm=!1,this._showAddClient=!1,this._queryLogs=[],this._queryLoading=!1,this._queryLive=!0,this._querySearch="",this._queryType="all",this._queryClient="all",this._queryError="",this._queryOldest="",this._queryFullyLoaded=!1}connectedCallback(){super.connectedCallback(),this._startQueryPolling()}disconnectedCallback(){super.disconnectedCallback(),this._stopQueryPolling()}updated(t){t.has("member")&&(this._queryLogs=[],this._queryOldest="",this._queryFullyLoaded=!1,this._loadQueryLog())}render(){if(!this.member)return n``;const t=this.member.client_names.map(o=>this.state.clients.find(c=>c.name===o)).filter(Boolean),e=this._activePolicies(),i=e[0],s=this._blockedServices(e),a=this._allowedServices(e),r=e.length>0&&(s.length>0||e.some(o=>o.rules.some(c=>c.action==="block")));return n`
      <div class="page">
        ...
        <section class="hero card">
          ...
          <div class="hero-actions">
            ...
            <button class="icon-btn" title="Delete" @click=${()=>{this._showDeleteConfirm=!0}}><ha-icon .path=${je.trash}></ha-icon></button>
          </div>
        </section>
        ...
        <div class="layout">
          <main class="main-column">
            <div class="grid-3">
              <section class="card stat-card">
                ...
                <div class="status-row">
                  <strong class=${r?"yellow":"green-text"}>${r?"RESTRICTED":"UNRESTRICTED"}</strong>
                  <div class="next-change">${i?n`<span>Next change</span><strong>${this._nextChange(i)}</strong>`:n`<span>No active schedule</span>`}</div>
                </div>
                <div class="subtext">${(i==null?void 0:i.name)||"No active policy"}${i!=null&&i.time_schedule?n` · ${this._scheduleText(i)}`:""}</div>
              </section>

              <section class="card stat-card">
                <div class="section-title">Allowed Services</div>
                <div class="service-line">
                  ${a.length?a.slice(0,3).map(o=>n`<span class="service allowed"><span class="service-dot">✓</span>${o}</span>`):n`<span class="muted">No explicit allow rules</span>`}
                </div>
              </section>
              ...
              <section class="card stat-card">
                ...
                <div class="service-line">
                  ${s.length?s.slice(0,4).map(o=>n`<span class="service blocked"><span class="service-dot">×</span>${o}</span>`):n`<span class="muted">No explicit blocked services</span>`}
                  ${s.length>4?n`<span class="more">+${s.length-4}</span>`:""}
                </div>
              </section>
            </div>
            ...
            <section class="card section-card">
                ...
                <tbody>
                  ${t.map(o=>n`
                    <tr @click=${()=>{var c;return(c=this.onNavigate)==null?void 0:c.call(this,"client-detail",o)}}>
                      <td><div class="client-cell"><span class="device-icon">▣</span><div><strong>${o.name}</strong>${o===t[0]?n`<small>Primary device</small>`:""}</div></div></td>
                      <td class="mono">${o.ids[0]||"—"}</td>
                      <td><span class="pill ${r?"yellow-pill":"green"}">${r?"RESTRICTED":"NORMAL"}</span></td>
              ...
              ${t.length?"":n`<div class="empty">No clients assigned. Add a client below.</div>`}
              <div class="add-row">
                <button class="btn" @click=${()=>{this._showAddClient=!0}}>+ Add Client</button>
              </div>
            </section>
            ...
            <section class="card section-card">
              <div class="section-head"><h2>Active Policy</h2>${i?n`<button class="btn small" @click=${()=>{var o;return(o=this.onNavigate)==null?void 0:o.call(this,"policy-detail",i)}}>View Policy ↗</button>`:""}</div>
              ${i?n`
              ...
              `:n`<div class="empty">No active policy at the current time.</div>`}
            </section>
            ...
            <div class="grid-2">
              <section class="card section-card compact">
                ...
                ${this.member.exceptions.length?this.member.exceptions.map(o=>n`<div class="exception"><span>${o}</span><button class="icon-btn" @click=${()=>this._removeException(o)}>×</button></div>`):n`<div class="empty">No exceptions for this member</div>`}
          ...
          <aside class="query-panel card">
            ...
            <div class="filters">
              <select class="field" @change=${o=>{this._queryClient=o.target.value}}>
                ...
                ${t.map(o=>n`<option value="${o.name}">${o.name}</option>`)}
              </select>
              ...
              <button class="icon-btn" title="Refresh" @click=${this._loadQueryLog}><ha-icon .path=${je.refresh}></ha-icon></button>
            </div>
            ${this._queryError?n`<div class="query-error">${this._queryError}</div>`:""}
            <div class="query-table-wrap">
              <table class="table query-table">
                ...
                <tbody>
                  ${this._filteredLogs().slice(0,50).map(o=>{var c;return n`
                    <tr>
                      <td class="time">${this._formatTime(o.time)}</td>
                      <td>${o.member_client||o.client}</td>
                      <td><div class="domain-cell"><span class="svc-icon">${Ke(S(o),18)}</span><strong>${S(o)||"—"}</strong></div></td>
                      <td>${this._isBlocked(o)?n`<span class="pill red">BLOCKED</span>`:n`<span class="pill green">PROCESSED</span>`}</td>
                      <td>${((c=o.question)==null?void 0:c.type)||"A"}</td>
                    </tr>
                  `})}
                </tbody>
              </table>
              ${this._queryLoading&&!this._queryLogs.length?n`<div class="empty loading-log">Loading query log…</div>`:""}
              ${!this._queryLoading&&!this._filteredLogs().length?n`<div class="empty loading-log">No DNS queries found for this member.</div>`:""}
            </div>
      ...
      ${this._showAddClient?n`
        ...
        <div class="modal">
          ...
          <div class="modal-body">
            ${this.state.clients.filter(o=>!this.member.client_names.includes(o.name)).length===0?n`<p class="empty">No available clients</p>`:this.state.clients.filter(o=>!this.member.client_names.includes(o.name)).map(o=>n`
  ...
  `;_([d({attribute:!1})],v.prototype,"hass",2);_([d({attribute:!1})],v.prototype,"state",2);_([d({attribute:!1})],v.prototype,"member",2);_([d({type:Boolean})],v.prototype,"narrow",2);_([d({type:Object})],v.prototype,"onNavigate",2);_([d({type:Object})],v.prototype,"onStateChanged",2);_([p()],v.prototype,"_newException",2);_([p()],v.prototype,"_showDeleteConfirm",2);_([p()],v.prototype,"_showAddClient",2);_([p()],v.prototype,"_queryLogs",2);_([p()],v.prototype,"_queryLoading",2);_([p()],v.prototype,"_queryLive",2);_([p()],v.prototype,"_querySearch",2);_([p()],v.prototype,"_queryType",2);_([p()],v.prototype,"_queryClient",2);_([p()],v.prototype,"_queryError",2);_([p()],v.prototype,"_queryOldest",2);_([p()],v.prototype,"_queryFullyLoaded",2);v=_([L("member-view")],v);var zt=Object.defineProperty,Nt=Object.getOwnPropertyDescriptor,D=(t,e,i,s)=>{for(var a=s>1?void 0:s?Nt(e,i):e,r=t.length-1,o;r>=0;r--)(o=t[r])&&(a=(s?o(e,i,a):o(a))||a);return s&&a&&zt(e,i,a),a};let A=class extends x{constructor(){super(...arguments),this.narrow=!1,this._showAddRule=!1,this._newRuleTarget="",this._newRuleAction="block",this._newRuleType="domain",this._showDeleteConfirm=!1}render(){return this.profile?n`
      <ha-card>
        <div class="card-header">
      ...
      <ha-card>
        ...
        <div class="card-content">
          ...
          `:""}
          ${this.profile.rules.length===0?n`<p class="empty">No rules defined</p>`:n`
                <table class="data-table">
                  <thead><tr><th>Type</th><th>Target</th><th>Action</th><th></th></tr></thead>
                  <tbody>
                    ${this.profile.rules.map((t,e)=>n`
                      <tr>
                        <td><span class="badge">${t.rule_type}</span></td>
  ...
  `;D([d({attribute:!1})],A.prototype,"hass",2);D([d({attribute:!1})],A.prototype,"state",2);D([d({attribute:!1})],A.prototype,"profile",2);D([d({type:Boolean})],A.prototype,"narrow",2);D([d({type:Object})],A.prototype,"onNavigate",2);D([d({type:Object})],A.prototype,"onStateChanged",2);D([p()],A.prototype,"_showAddRule",2);D([p()],A.prototype,"_newRuleTarget",2);D([p()],A.prototype,"_newRuleAction",2);D([p()],A.prototype,"_newRuleType",2);D([p()],A.prototype,"_showDeleteConfirm",2);A=D([L("profile-view")],A);var qt=Object.defineProperty,Vt=Object.getOwnPropertyDescriptor,j=(t,e,i,s)=>{for(var a=s>1?void 0:s?Vt(e,i):e,r=t.length-1,o;r>=0;r--)(o=t[r])&&(a=(s?o(e,i,a):o(a))||a);return s&&a&&qt(e,i,a),a};let z=class extends x{constructor(){super(...arguments),this.kind="clients",this._showAdd=!1,this._newName="",this._newSecondary=""}_icon(t,e=15){return N`<svg viewBox="0 0 24 24" width="${e}" height="${e}"><path fill="currentColor" d="${t}"></path></svg>`}get _config(){switch(this.kind){case"groups":return{title:"Groups",icon:g.groups,columns:["Name","Members","Clients","Policies"],items:this.state.groups,nameField:"name",rowValues:t=>[t.member_names.length,t.client_names.length,t.assigned_policy_ids.length],detailView:"group-detail",secondaryLabel:null};case"members":return{title:"Members",icon:g.members,columns:["Name","Clients","Policies","Exceptions"],items:this.state.members,nameField:"name",rowValues:t=>[t.client_names.length,t.assigned_policy_ids.length,t.exceptions.length],detailView:"member-detail",secondaryLabel:null};case"clients":return{title:"Clients",icon:g.clients,columns:["Name","IDs","Policies","Status"],items:this.state.clients,nameField:"name",rowValues:t=>[t.ids.length?t.ids.join(", "):"—",t.assigned_policy_ids.length,t.assigned_policy_ids.length?"Restricted":"Unrestricted"],detailView:"client-detail",secondaryLabel:"IP / ID (optional)"};case"policies":return{title:"Policies",icon:g.policies,columns:["Name","Priority","Rules","Profile"],items:this.state.policies,nameField:"name",rowValues:t=>[t.priority,t.rules.length,this._profileName(t.profile_id)],detailView:"policy-detail",secondaryLabel:null};case"profiles":default:return{title:"Profiles",icon:g.profiles,columns:["Name","Rules","Default Action"],items:this.state.profiles,nameField:"name",rowValues:t=>[t.rules.length,t.default_action],detailView:"profile-detail",secondaryLabel:null}}}_profileName(t){var e;return t?((e=this.state.profiles.find(i=>i.id===t))==null?void 0:e.name)||t:"None"}render(){if(!this.state)return n``;const t=this._config;return n`
      <div class="card">
        <div class="card-head">
          <div class="head-left">
          ...
          <button class="btn primary" @click=${()=>{this._showAdd=!0}}>
            ${this._icon(g.plus,14)} Add ${t.title.slice(0,-1)}
          </button>
        </div>

        ${t.items.length===0?n`<div class="empty-state">No ${t.title.toLowerCase()} configured yet.</div>`:n`
              <table class="table">
                <thead>
                  <tr>
                    ${t.columns.map(e=>n`<th>${e}</th>`)}
                    <th></th>
                  </tr>
                </thead>
                <tbody>
                  ${t.items.map(e=>{const i=t.rowValues(e);return n`
                      <tr class="clickable" @click=${()=>{var s;return(s=this.onNavigate)==null?void 0:s.call(this,t.detailView,e)}}>
                        ...
                        ${i.map(s=>n`<td>${s}</td>`)}
                        <td class="menu-cell">
                          <span class="icon-btn">${this._icon(g.chevronRight,15)}</span>
                        </td>
                      </tr>
                    `})}
                </tbody>
          ...
          <div class="modal" @click=${e=>e.stopPropagation()}>
            ...
            <div class="modal-fields">
              <input class="field" placeholder="${t.title.slice(0,-1)} name" .value=${this._newName}
                ...
                autofocus
              />
              ${t.secondaryLabel?n`<input class="field" placeholder="${t.secondaryLabel}" .value=${this._newSecondary}
    ...
    `];j([d({attribute:!1})],z.prototype,"hass",2);j([d({attribute:!1})],z.prototype,"state",2);j([d({type:String})],z.prototype,"kind",2);j([d({type:Object})],z.prototype,"onNavigate",2);j([d({type:Object})],z.prototype,"onStateChanged",2);j([p()],z.prototype,"_showAdd",2);j([p()],z.prototype,"_newName",2);j([p()],z.prototype,"_newSecondary",2);z=j([L("list-view")],z);var Ot=Object.defineProperty,Ht=Object.getOwnPropertyDescriptor,ye=(t,e,i,s)=>{for(var a=s>1?void 0:s?Ht(e,i):e,r=t.length-1,o;r>=0;r--)(o=t[r])&&(a=(s?o(e,i,a):o(a))||a);return s&&a&&Ot(e,i,a),a};let ie=class extends x{constructor(){super(...arguments),this.title="Coming soon",this.description="This section isn't available yet.",this.icon=""}_icon(t){return N`<svg viewBox="0 0 24 24" width="30" height="30"><path fill="currentColor" d="${t}"></path></svg>`}render(){return n`
      <div class="card empty-card">
        ${this.icon?n`<div class="empty-icon">${this._icon(this.icon)}</div>`:""}
    ...
    `];ye([d({type:String})],ie.prototype,"title",2);ye([d({type:String})],ie.prototype,"description",2);ye([d({type:String})],ie.prototype,"icon",2);ie=ye([L("placeholder-view")],ie);var Rt=Object.defineProperty,jt=Object.getOwnPropertyDescriptor,ae=(t,e,i,s)=>{for(var a=s>1?void 0:s?jt(e,i):e,r=t.length-1,o;r>=0;r--)(o=t[r])&&(a=(s?o(e,i,a):o(a))||a);return s&&a&&Rt(e,i,a),a};const It=[{id:"dashboard",label:"Dashboard",icon:g.dashboard},{id:"groups",label:"Groups",icon:g.groups},{id:"members",label:"Members",icon:g.members},{id:"clients",label:"Clients",icon:g.clients},{id:"policies",label:"Policies",icon:g.policies},{id:"profiles",label:"Profiles",icon:g.profiles},{id:"schedules",label:"Schedules",icon:g.schedules},{id:"services",label:"Services",icon:g.services},{id:"override",label:"Overrides",icon:g.overrides},{id:"logs",label:"Logs",icon:g.logs},{id:"settings",label:"Settings",icon:g.settings}],Ft={dashboard:"dashboard",groups:"groups","group-detail":"groups",members:"members","member-detail":"members",clients:"clients","client-detail":"clients",policies:"policies","policy-detail":"policies",profiles:"profiles","profile-detail":"profiles",schedules:"schedules",services:"services",override:"override",logs:"logs",settings:"settings"};let B=class extends x{constructor(){super(...arguments),this.activeView="dashboard",this.state=null,this.protectionEnabled=!0}_icon(t){return N`<svg viewBox="0 0 24 24" width="18" height="18"><path fill="currentColor" d="${t}"></path></svg>`}_badgeFor(t){if(this.state)switch(t){case"groups":return this.state.groups.length||void 0;case"members":return this.state.members.length||void 0;case"clients":return this.state.clients.length||void 0;case"policies":return this.state.policies.length||void 0;case"profiles":return this.state.profiles.length||void 0;case"override":return this.state.overrides.length||void 0;default:return}}render(){const t=Ft[this.activeView]||"dashboard";return n`
      <div class="brand">
        <div class="brand-icon">${this._icon(g.shield)}</div>
      ...
      <nav class="nav">
        ${It.map(e=>{const i=this._badgeFor(e.id),s=e.id===t;return n`
            <button
            ...
            >
              ...
              ${i!==void 0?n`<span class="nav-badge">${i}</span>`:""}
            </button>
          `})}
      </nav>
  ...
  `;ae([d({type:String})],B.prototype,"activeView",2);ae([d({attribute:!1})],B.prototype,"state",2);ae([d({type:Boolean})],B.prototype,"protectionEnabled",2);ae([d({type:Object})],B.prototype,"onNavigate",2);ae([d({type:Object})],B.prototype,"onToggleProtection",2);B=ae([L("agpc-sidebar")],B);var Wt=Object.defineProperty,Bt=Object.getOwnPropertyDescriptor,X=(t,e,i,s)=>{for(var a=s>1?void 0:s?Bt(e,i):e,r=t.length-1,o;r>=0;r--)(o=t[r])&&(a=(s?o(e,i,a):o(a))||a);return s&&a&&Wt(e,i,a),a};let H=class extends x{constructor(){super(...arguments),this.title="Dashboard",this.showBack=!1,this.lastSync=null,this.syncing=!1}_icon(t,e=18){return N`<svg viewBox="0 0 24 24" width="${e}" height="${e}"><path fill="currentColor" d="${t}"></path></svg>`}render(){return n`
      <div class="left">
        ${this.showBack?n`
      ...
      <div class="right">
        ${this.lastSync?n`<span class="sync-label">Last sync: ${this.lastSync}</span>`:m}
        ...
        <button class="icon-btn" aria-label="Toggle theme">${this._icon(g.moon)}</button>
        <button class="icon-btn" aria-label="More">${this._icon(g.dots)}</button>
      </div>
    `}};H.styles=C`
    :host {
      display: flex;
  ...
  `;X([d({type:String})],H.prototype,"title",2);X([d({type:Boolean})],H.prototype,"showBack",2);X([d({type:String})],H.prototype,"lastSync",2);X([d({type:Boolean})],H.prototype,"syncing",2);X([d({type:Object})],H.prototype,"onBack",2);X([d({type:Object})],H.prototype,"onRefresh",2);H=X([L("agpc-topbar")],H);var Ut=Object.defineProperty,Zt=Object.getOwnPropertyDescriptor,ge=(t,e,i,s)=>{for(var a=s>1?void 0:s?Zt(e,i):e,r=t.length-1,o;r>=0;r--)(o=t[r])&&(a=(s?o(e,i,a):o(a))||a);return s&&a&&Ut(e,i,a),a};const Gt={mon:"Mon",tue:"Tue",wed:"Wed",thu:"Thu",fri:"Fri",sat:"Sat",sun:"Sun"};let K=class extends x{_icon(t,e=16){return N`<svg viewBox="0 0 24 24" width="${e}" height="${e}"><path fill="currentColor" d="${t}"></path></svg>`}_scheduleRows(){return this.state.policies.filter(t=>t.time_schedule).map(t=>({policyId:t.id,policyName:t.name,priority:t.priority,days:t.time_schedule.days,timeFrom:t.time_schedule.time_from,timeTo:t.time_schedule.time_to,rulesCount:t.rules.length})).sort((t,e)=>e.priority-t.priority)}_unscheduledPolicies(){return this.state.policies.filter(t=>!t.time_schedule)}render(){if(!this.state)return n``;const t=this._scheduleRows(),e=this._unscheduledPolicies();return n`
      <div class="card">
        <div class="card-head">
          <div class="head-left">
            <div class="head-icon">${this._icon(g.schedules,18)}</div>
          ...
          <button class="btn" @click=${()=>{var i;return(i=this.onNavigate)==null?void 0:i.call(this,"policies")}}>
            ${this._icon(g.policies,14)} Manage Policies
          </button>
        </div>

        ${t.length===0?n`<div class="empty-state">No schedules configured yet. Add a time schedule to a policy to see it here.</div>`:n`
              <table class="table">
                <thead>
                  <tr>
                    <th>Policy</th>
                ...
                <tbody>
                  ${t.map(i=>n`
                    <tr class="clickable" @click=${()=>{var a;const s=this.state.policies.find(r=>r.id===i.policyId);s&&((a=this.onNavigate)==null||a.call(this,"policy-detail",s))}}>
                      ...
                      <td>
                        <div class="day-chips">
                          ${["mon","tue","wed","thu","fri","sat","sun"].map(s=>n`<span class="day-chip ${i.days.includes(s)?"active":""}">${Gt[s]}</span>`)}
                        </div>
                      </td>
                      <td class="time-cell">
          ...
          <div class="unscheduled-list">
            ${e.map(i=>n`
              <div class="unscheduled-item clickable" @click=${()=>{var s;return(s=this.onNavigate)==null?void 0:s.call(this,"policy-detail",i)}}>
                ...
                <span class="icon-btn">${this._icon(g.chevronRight,14)}</span>
              </div>
            `)}
          </div>
        </div>
              ...
              <div class="category-tabs">
                ...
                ${e.map(a=>n`
                  <button class="cat-tab ${this._selectedCategory===a?"active":""}"
                    ...
                    ${Ie[a]||a}
                    <span class="cat-count">${this._services.filter(r=>{var o;return(o=r.categories)==null?void 0:o.includes(a)}).length}</span>
                  </button>
                `)}
              </div>

              ${this._selectedCategory==="all"?n`
                    ${[...i.entries()].map(([a,r])=>n`
                      <div class="category-section">
                        <div class="cat-header">
                          <span class="cat-title">${Ie[a]||a}</span>
                          <span class="cat-badge">${r.filter(o=>o.blocked).length} / ${r.length} blocked</span>
                        </div>
                        <div class="service-grid">
                          ${r.map(o=>this._renderService(o))}
                        </div>
                      </div>
                    `)}
                  `:n`
    ...
    `];V([d({attribute:!1})],T.prototype,"hass",2);V([d({attribute:!1})],T.prototype,"state",2);V([d({type:Object})],T.prototype,"onNavigate",2);V([d({type:Object})],T.prototype,"onStateChanged",2);V([p()],T.prototype,"_services",2);V([p()],T.prototype,"_loading",2);V([p()],T.prototype,"_search",2);V([p()],T.prototype,"_saving",2);V([p()],T.prototype,"_selectedCategory",2);T=V([L("services-view")],T);var Kt=Object.defineProperty,Xt=Object.getOwnPropertyDescriptor,M=(t,e,i,s)=>{for(var a=s>1?void 0:s?Xt(e,i):e,r=t.length-1,o;r>=0;r--)(o=t[r])&&(a=(s?o(e,i,a):o(a))||a);return s&&a&&Kt(e,i,a),a};const Jt={logs:{title:"Logs",description:"Query and activity logs will appear here once log streaming is wired up."},settings:{title:"Settings",description:"Integration and sync settings will be available here soon."}};let k=class extends x{constructor(){super(...arguments),this._view="dashboard",this._state=null,this._selectedClient=null,this._selectedPolicy=null,this._selectedGroup=null,this._selectedMember=null,this._selectedProfile=null,this._loading=!0,this._syncing=!1,this._protectionEnabled=!0,this._lastSync=null,this._api=null,this._navigate=(t,e)=>{this._view=t,t==="client-detail"&&e&&(this._selectedClient=e),t==="policy-detail"&&e&&(this._selectedPolicy=e),t==="group-detail"&&e&&(this._selectedGroup=e),t==="member-detail"&&e&&(this._selectedMember=e),t==="profile-detail"&&e&&(this._selectedProfile=e),this._loadState(),this.requestUpdate()},this._onStateChanged=async()=>{await this._loadState()},this._sync=async()=>{if(!(!this.hass||this._syncing)){this._syncing=!0;try{await this.hass.callWS({type:"adguard_pc/sync"}),await this._loadState()}catch(t){console.error("Sync failed:",t)}finally{this._syncing=!1}}}}updated(t){t.has("hass")&&this.hass&&!this._api&&(this._api=new xt(this.hass),this._loadState())}async _loadState(){if(this._api)try{this._state=await this._api.getState(),this._lastSync=new Date().toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})}catch(t){console.error("Failed to load state:",t)}finally{this._loading=!1}}render(){if(this._loading)return n`
        <div class="shell">
          <div class="loading">
      ...
      `;if(!this._state)return n`
        <div class="shell">
          <div class="loading">
            <p>Failed to load state. Check your AdGuard Home connection.</p>
          </div>
        </div>
      `;const t=this._view.endsWith("-detail")||this._view==="override";return n`
      <div class="shell">
        <agpc-sidebar
    ...
    `}get _viewTitle(){var t,e,i,s,a;switch(this._view){case"client-detail":return((t=this._selectedClient)==null?void 0:t.name)||"Client";case"policy-detail":return((e=this._selectedPolicy)==null?void 0:e.name)||"Policy";case"group-detail":return((i=this._selectedGroup)==null?void 0:i.name)||"Group";case"member-detail":return((s=this._selectedMember)==null?void 0:s.name)||"Member";case"profile-detail":return((a=this._selectedProfile)==null?void 0:a.name)||"Profile";case"override":return"Overrides";case"groups":return"Groups";case"members":return"Members";case"clients":return"Clients";case"policies":return"Policies";case"profiles":return"Profiles";case"schedules":return"Schedules";case"services":return"Services";case"logs":return"Logs";case"settings":return"Settings";default:return"Dashboard"}}_renderContent(){switch(this._view){case"dashboard":return n`<dashboard-view .state=${this._state} .hass=${this.hass} .onNavigate=${this._navigate}></dashboard-view>`;case"client-detail":return n`<client-view .state=${this._state} .hass=${this.hass} .client=${this._selectedClient} .onNavigate=${this._navigate} .onStateChanged=${this._onStateChanged}></client-view>`;case"policy-detail":return n`<policy-view .state=${this._state} .hass=${this.hass} .policy=${this._selectedPolicy} .onNavigate=${this._navigate} .onStateChanged=${this._onStateChanged}></policy-view>`;case"group-detail":return n`<group-view .state=${this._state} .hass=${this.hass} .group=${this._selectedGroup} .onNavigate=${this._navigate} .onStateChanged=${this._onStateChanged}></group-view>`;case"member-detail":return n`<member-view .state=${this._state} .hass=${this.hass} .member=${this._selectedMember} .onNavigate=${this._navigate} .onStateChanged=${this._onStateChanged}></member-view>`;case"profile-detail":return n`<profile-view .state=${this._state} .hass=${this.hass} .profile=${this._selectedProfile} .onNavigate=${this._navigate} .onStateChanged=${this._onStateChanged}></profile-view>`;case"override":return n`<override-view .state=${this._state} .hass=${this.hass} .onNavigate=${this._navigate} .onStateChanged=${this._onStateChanged}></override-view>`;case"groups":return n`<list-view kind="groups" .state=${this._state} .hass=${this.hass} .onNavigate=${this._navigate} .onStateChanged=${this._onStateChanged}></list-view>`;case"members":return n`<list-view kind="members" .state=${this._state} .hass=${this.hass} .onNavigate=${this._navigate} .onStateChanged=${this._onStateChanged}></list-view>`;case"clients":return n`<list-view kind="clients" .state=${this._state} .hass=${this.hass} .onNavigate=${this._navigate} .onStateChanged=${this._onStateChanged}></list-view>`;case"policies":return n`<list-view kind="policies" .state=${this._state} .hass=${this.hass} .onNavigate=${this._navigate} .onStateChanged=${this._onStateChanged}></list-view>`;case"profiles":return n`<list-view kind="profiles" .state=${this._state} .hass=${this.hass} .onNavigate=${this._navigate} .onStateChanged=${this._onStateChanged}></list-view>`;case"schedules":return n`<schedule-view .state=${this._state} .hass=${this.hass} .onNavigate=${this._navigate} .onStateChanged=${this._onStateChanged}></schedule-view>`;case"services":return n`<services-view .state=${this._state} .hass=${this.hass} .onNavigate=${this._navigate} .onStateChanged=${this._onStateChanged}></services-view>`;case"logs":case"settings":{const t=Jt[this._view];return n`<placeholder-view .title=${t.title} .description=${t.description}></placeholder-view>`}default:return n`<dashboard-view .state=${this._state} .hass=${this.hass} .onNavigate=${this._navigate}></dashboard-view>`}}};k.styles=[ft,C`
      .shell {
        display: flex;
        height: 100vh;
        width: 100%;
    ...
    `];M([d({attribute:!1})],k.prototype,"hass",2);M([p()],k.prototype,"_view",2);M([p()],k.prototype,"_state",2);M([p()],k.prototype,"_selectedClient",2);M([p()],k.prototype,"_selectedPolicy",2);M([p()],k.prototype,"_selectedGroup",2);M([p()],k.prototype,"_selectedMember",2);M([p()],k.prototype,"_selectedProfile",2);M([p()],k.prototype,"_loading",2);M([p()],k.prototype,"_syncing",2);M([p()],k.prototype,"_protectionEnabled",2);M([p()],k.prototype,"_lastSync",2);k=M([L("adguard-parental-control")],k);
